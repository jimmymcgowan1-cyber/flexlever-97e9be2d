            ...
            <div className="space-y-8 mb-10">
              <div>
                <div className="flex justify-between mb-3">
                  <label className="text-sm font-medium">Hours on manual tasks per week</label>
              ...
              <div>
                <div className="flex justify-between mb-3">
                  <label className="text-sm font-medium">Average hourly cost</label>
                  <span className="text-sm font-bold text-primary">${avgRate}/hr</span>
                </div>
                <Slider value={[avgRate]} onValueChange={([v]) => setAvgRate(v)} min={15} max={100} step={5} />
              </div>
            </div>
